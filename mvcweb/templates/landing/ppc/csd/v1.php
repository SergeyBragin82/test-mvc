...
<div class="hawaiian-airlines">
		...
		<div class="row">
			<div class="col-xl-4">
				<div class="hero-element-info">
					...
					<form id="request_information_left" method="post" accept-charset="utf-8" action="<?php echo $actionURL; ?>">
						<input type="hidden" name="action" value="request_information_left">
							...
							<div class="hero-element-info-body">
								...
								<div class="form-group">
									<select class="form-control" id="memberStatus" name="memberStatus" required="">
										<option value="" selected="">Are you a Marriott Vacation Club Owner?</option>
	...
	<script>
		...
		var callSubmittedEntrySuccess = function() {
			window.location.replace("/landing/ppc/csd/v1thankyou/");
		}
