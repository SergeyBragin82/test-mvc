	...
	<div class="container-fluid hero-element">
						...
						<div class="ha-step ha-step--1" id="haStep1">
							...
							<div class="hero-element-info-body">
								...
								<div class="form-group">
									...
									<div class="invalid-feedback" id="memberStatusSelectError" style="display: none;">
								...
								<div class="form-group">
									<select class="form-control" id="countryCodeSelect" name="addressCountryCode" required="">
										<option value="" style="display: none;" selected="">Country/Region</option>
		...
		<div class="row" style="padding: 32px;">
			<div class="col-xl-5">
				...
				<p>Owner in the Marriott Vacation Club Destinations&trade; Ownership Program, you may use your annual Vacation Club Points to enjoy weeks of vacation in luxurious destinations. You can also use them for weekend getaways and other vacation experiences. It's completely flexible - you decide where and how to want to vacation.</p>
			</div>
			<div class="col-xl-5 offset-md-2">
				...
				<ul style="padding-top: 32px;">
					...
					<li><h6 style="font-weight: bold;">MORE THAN 3,000 MARRIOTT<sup>&reg;</sup> HOTELS AND RESORTS</h6></li>
					<li><h6 style="font-weight: bold;">SPECIALTY TRAVEL OPTIONS INCLUDING SAFARIS, WINE TOURS AND CRUISES</h6></li>
					<li><h6 style="font-weight: bold;">MORE THAN HUNDREDS OF AFFILIATE RESORTS IN DOZENS OF COUNTRIES</h6></li>
				</ul>
			</div>
		</div><!--  / .row -->
		<div class="row" style="padding: 32px;">
