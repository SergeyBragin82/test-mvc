...
<div class="mainheader">
    ...
    <div class="d-flex">
        <div class="headerrectangle py-0 px-0 py-md-3 px-md-4 align-self-center">
...
<div class="marriottpackages">
    <div class="container container-mobile">
        <div class="row">
            <div class="col-sm-12 col-lg-6 choice-is-yours text-center text-md-left">
                <div class="mt-2 mt-md-4 pl-3 pr-3 pl-md-0 pr-md-0">
                    ...
                    <div class="participationdetails">
                        <h4><p class="particpationclick pt-0 mt-0">
                                <a href="/landing/cc/offers-b/details?loc=<?php echo $loc_set; ?>">Click Here for Details of Participation</a>
                            </p></h4>
                    </div>
                </div>
            </div>
            <div class="col-sm-12 col-lg-6 text-center text-md-left">
                <div class="goldline mt-md-5 mt-2 mx-auto mx-md-0"></div>
        ...
        <div class="row mt-1 mt-md-5">
            <div class="col-lg text-center mb-5">
                <a class="a-link" href="/landing/cc/offers-b/newport/?fid=<?php echo $loc["main_npc_fid"];?>&loc=<?php echo $loc["main_npc_loc"];?>&main_loc=<?php echo $loc_set;?>">
                    <div class="image-description-border pb-2">
                        ...
                        <div class="pl-3 pr-3">
                            ...
                            <p class="for-details-apply">Conditions apply. For details, click Get Offer</p>
                        </div>
                    </div>
                </a>
    ...
    <div class="participationdetails text-center mb-4">
        <h4><p class="particpationclick pt-0 mt-0">
                <a href="/landing/cc/offers-b/details/details?loc=<?php echo $loc_set; ?>">Tap Here for Details of Participation</a>
            </p>
        </h4>
    </div>
</div>
