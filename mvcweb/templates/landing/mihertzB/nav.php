 <div id="sidebar-wrapper">
 	...
 	<div class="navlinks py-4 pl-4 pr-2" id="navGroup">
 		<?php
 			navlink("/landing/cc/offers-c/newport/?fid=" . $loc["main_npc_fid"] ."&loc=" . $loc["main_npc_loc"] . "&main_loc=" . $loc_set, "Newport Coast, California", 0, false, $loc_set);
 			navlink("/landing/cc/offers-c/newyorkcity/?fid=" .  $loc["main_nyc_fid"] . "&loc=" . $loc["main_nyc_loc"]  . "&main_loc=" . $loc_set, "New York City, New York", 1, true, $loc_set);
 			navlink("/landing/cc/offers-c/orlando/?fid=" . $loc["main_orl_fid"]  . "&loc=" .  $loc["main_orl_loc"] . "&main_loc=" . $loc_set, "Orlando, Florida", 2, false, $loc_set);
 			navlink("/landing/cc/offers-c/palmbeaches/?fid=" .  $loc["main_sin_fid"] . "&loc=" .  $loc["main_sin_loc"] . "&main_loc=" . $loc_set , "The Palm Beaches, Florida" , 3, false, $loc_set);
	...
	<div id="collapse<?php echo $index; ?>" class="collapse" aria-labelledby="headingCollapse<?php echo $index; ?>" data-parent="#navGroup">
	    <div class="card-body">
	        <ul>
				...
				<li><a class="nlink" href="/landing/cc/offers-c/details?loc=<?php echo $loc_set;?>">Details of Participation</a></li>
			</ul>
	    </div>
	</div>
<?php } ?>