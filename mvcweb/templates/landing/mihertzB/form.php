        ...
        geo.geocode({
            ...
            if (status === google.maps.GeocoderStatus.OK) {
                var onlyPostalType = results.filter(function (result) {
                    return result.types.length ? result.types[0] === 'postal_code' : false;
                });
            ...
            //$("#hertzInfoForm").submit();
            $("#hertzInfoForm").submit(function (e) {
                var form = $(this);
    ...
    <div class="row mx-0">
        <div class="col d-flex light-grey-bg resortdcopy-container p-0 mt-0">
            <div class="resortdcopy mx-auto mr-3 d-flex align-items-center">
                <h3 class="teal-fg mb-0 days-nights">4 DAYS, 3 NIGHTS </h3><span class="price-now">NOW </span><span class="teal-fg price-large"><?php echo $context->xpath("//price")[0]; ?></span>
            </div>
        </div>
...
<div class="choice-container white-bg">
    <div class="container">
        <div class="row pb-0">
            <div class="col-lg order-2 order-lg-1 d-flex flex-column pt-5">
            ...
            <div class="col-lg order-1 order-lg-2">
                <div class="call-us-at text-center mt-3">
                    ...
                    <p class="flexsimply mt-0">Or, simply fill out the form below</p>
                ...
                <?php } else { ?>
                    ...
                    <form id='hertzInfoForm' method='post' action="/wp-admin/admin-post.php" class="p-2">
                        ...
                        <input type="submit" class="form-submit w-75 px-5 py-2 text-center mx-auto" value="SUBMIT"/>

                        <div class="form-check mt-3 w-75 mx-auto">
                    ...
                    <div class="text-center"><a class="teal-fg tap-details" href="/landing/cc/offers/details?loc=<?php echo $loc_set; ?>">Tap here for Details of Participation</a></div>
                <?php } ?>
            </div></div></div></div>
	...
	function setTripAdvisorQuote(taData) {
		...
		reviewText = reviewText.substr(0, indexCutoff) + "...<span class='quote-more'>more</span>";
			...
			setupLegalPopup($('<a>').attr('href', review.url)
				.append(
					$('<blockquote class="ta-quote-content teal-border p-2">')
