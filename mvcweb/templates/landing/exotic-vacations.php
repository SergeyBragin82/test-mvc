	...
	<div class="container-fluid hero-element">
		<div class="row">
			...
			<div class="col-xl-8 fluid-video">
				<iframe width="560" height="315" src="https://www.youtube.com/embed/MABeuU_xLps?rel=0&amp;autoplay=1&mute=1" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
			</div><!-- / .fluid-video -->
		</div><!--  / .row -->
	</div><!--  / .hero-element -->
</div><!--  / .ydraw -->
